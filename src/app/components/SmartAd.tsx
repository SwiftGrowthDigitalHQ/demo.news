...
function FooterPromo() {
  return (
    <div className="block rounded-2xl overflow-hidden transition-all duration-300">
      <div className="bg-gradient-to-r from-gray-800 via-gray-900 to-gray-800 px-6 py-5 sm:py-6 flex items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="text-white text-base sm:text-lg font-bold">Advertise With Us</div>
            <div className="text-gray-400 text-[11px] mt-0.5">Reach thousands of readers every day</div>
          </div>
        </div>
        <div className="hidden sm:flex items-center gap-3">
          <a href="/advertise-with-us" className="bg-red-600 text-white px-4 py-2 rounded-lg text-xs font-bold flex items-center gap-1.5 shadow-md hover:bg-red-700">
