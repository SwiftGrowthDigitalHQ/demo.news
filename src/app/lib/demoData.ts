...
export const DEMO_CATEGORIES: PublicCategory[] = [
  { id: 'demo-cat-1', name: 'Bihar', slug: 'bihar', description: 'State news, government, and development reporting.', icon: '🗺️', color: '#fbbf24', cover_image_url: null, show_in_navbar: true, show_on_homepage: true, status: 'published', sort_order: 1, is_featured: true, seo_title: 'Bihar News – Demo News', seo_description: 'Latest news and updates from Bihar state.', og_image_url: null, canonical_url: null, article_count: 0 },
  { id: 'demo-cat-2', name: 'Politics', slug: 'politics', description: 'Elections, parliament, and civic affairs.', icon: '🏛️', color: '#ef4444', cover_image_url: null, show_in_navbar: true, show_on_homepage: true, status: 'published', sort_order: 2, is_featured: true, seo_title: 'Politics News – Demo News', seo_description: 'Political news, analysis and election coverage.', og_image_url: null, canonical_url: null, article_count: 0 },
  { id: 'demo-cat-3', name: 'Crime', slug: 'crime', description: 'Police, courts, and public safety reporting.', icon: '🚨', color: '#ef4444', cover_image_url: null, show_in_navbar: true, show_on_homepage: false, status: 'published', sort_order: 3, is_featured: true, seo_title: 'Crime News – Demo News', seo_description: 'Crime and public safety reporting.', og_image_url: null, canonical_url: null, article_count: 0 },
  { id: 'demo-cat-4', name: 'Education', slug: 'education', description: 'Schools, exams, results and student news.', icon: '🎓', color: '#8b5cf6', cover_image_url: null, show_in_navbar: true, show_on_homepage: false, status: 'published', sort_order: 4, is_featured: true, seo_title: 'Education News – Demo News', seo_description: 'Education news and exam updates.', og_image_url: null, canonical_url: null, article_count: 0 },
  { id: 'demo-cat-5', name: 'Sports', slug: 'sports', description: 'Cricket, football, kabaddi and athletics.', icon: '⚽', color: '#3b82f6', cover_image_url: null, show_in_navbar: true, show_on_homepage: false, status: 'published', sort_order: 5, is_featured: false, seo_title: 'Sports News – Demo News', seo_description: 'Sports results and match coverage.', og_image_url: null, canonical_url: null, article_count: 0 },
  { id: 'demo-cat-6', name: 'Technology', slug: 'technology', description: 'Digital innovation and technology news.', icon: '💻', color: '#06b6d4', cover_image_url: null, show_in_navbar: true, show_on_homepage: false, status: 'published', sort_order: 6, is_featured: false, seo_title: 'Technology News – Demo News', seo_description: 'Technology and digital innovation news.', og_image_url: null, canonical_url: null, article_count: 0 },
  { id: 'demo-cat-7', name: 'Business', slug: 'business', description: 'Markets, commerce and entrepreneurship.', icon: '💼', color: '#10b981', cover_image_url: null, show_in_navbar: true, show_on_homepage: false, status: 'published', sort_order: 7, is_featured: false, seo_title: 'Business News – Demo News', seo_description: 'Business and market news.', og_image_url: null, canonical_url: null, article_count: 0 },
  { id: 'demo-cat-8', name: 'Entertainment', slug: 'entertainment', description: 'Cinema, music, and cultural events.', icon: '🎬', color: '#ec4899', cover_image_url: null, show_in_navbar: true, show_on_homepage: false, status: 'published', sort_order: 8, is_featured: false, seo_title: 'Entertainment News – Demo News', seo_description: 'Entertainment and culture news.', og_image_url: null, canonical_url: null, article_count: 0 },
  { id: 'demo-cat-9', name: 'Health', slug: 'health', description: 'Healthcare, medicine and wellness.', icon: '⚕️', color: '#f43f5e', cover_image_url: null, show_in_navbar: false, show_on_homepage: false, status: 'published', sort_order: 9, is_featured: false, seo_title: 'Health News – Demo News', seo_description: 'Health and wellness news.', og_image_url: null, canonical_url: null, article_count: 0 },
  { id: 'demo-cat-10', name: 'National', slug: 'national', description: 'News from across India.', icon: '🇮🇳', color: '#a855f7', cover_image_url: null, show_in_navbar: true, show_on_homepage: true, status: 'published', sort_order: 10, is_featured: false, seo_title: 'National News – Demo News', seo_description: 'National news and updates from India.', og_image_url: null, canonical_url: null, article_count: 0 },
];
